...
## Purpose
Define a strict boundary and communication protocol for the HUD service to prevent domain object leakage and prepare the system for future multi-OS/RPC communication.
