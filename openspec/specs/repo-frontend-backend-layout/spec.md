...
format: spec
version: 1.0.0
title: "Repository Frontend Backend Layout"
status: active
---

## Purpose
The repository MUST expose distinct frontend and backend workspaces so application code, dependencies, and development workflows are no longer rooted in a single mixed top-level Python project.
